...
public class SuccessfulMoveOnWallSectorEvent extends GameEvent {

    /**
     * 
     */
    private static final long serialVersionUID = -6425829906078400852L;

    public SuccessfulMoveOnWallSectorEvent(String message) {
        super(message);
    }
