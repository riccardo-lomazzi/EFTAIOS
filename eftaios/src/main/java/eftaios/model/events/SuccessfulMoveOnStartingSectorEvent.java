...
public class SuccessfulMoveOnStartingSectorEvent extends GameEvent {

    /**
     * 
     */
    private static final long serialVersionUID = 151170361174796120L;

    public SuccessfulMoveOnStartingSectorEvent(String message) {
        super(message);
    }
