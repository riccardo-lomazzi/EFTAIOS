...
public class StartPlayerTurnEvent extends GameEvent {
     ...
     * 
     */
    private static final long serialVersionUID = 112491561279581121L;

    public StartPlayerTurnEvent(String message) {
        super(message);
