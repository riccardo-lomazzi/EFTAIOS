...
public class NoiseInYourSectorEvent extends GameEvent {

    /**
     * 
     */
    private static final long serialVersionUID = -2975428455387443144L;

    public NoiseInYourSectorEvent() {
    }

    public NoiseInYourSectorEvent(String message) {
        super(message);
    }
