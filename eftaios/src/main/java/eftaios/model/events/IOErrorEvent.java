...
public class IOErrorEvent extends GameEvent {
     ...
     * 
     */
    private static final long serialVersionUID = 3766168414255897114L;

    public IOErrorEvent(String message) {
        super(message);
    }
    
    public IOErrorEvent(String message, Exception e) {
