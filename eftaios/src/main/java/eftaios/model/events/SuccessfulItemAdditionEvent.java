...
public class SuccessfulItemAdditionEvent extends GameEvent{

    /**
     * 
     */
    private static final long serialVersionUID = 5127563819805662533L;

    public SuccessfulItemAdditionEvent(String message) {
        super(message);
    }
