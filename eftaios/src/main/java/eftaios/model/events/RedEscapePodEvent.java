...
public class RedEscapePodEvent extends GameEvent {

    /**
     * 
     */
    private static final long serialVersionUID = -7100881339386766662L;

    public RedEscapePodEvent() {
    }

    public RedEscapePodEvent(String message) {
        super(message);
    }
