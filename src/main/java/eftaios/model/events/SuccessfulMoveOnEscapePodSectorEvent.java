...
public class SuccessfulMoveOnEscapePodSectorEvent extends GameEvent {

    /**
     * 
     */
    private static final long serialVersionUID = 4106718424649541007L;


    public SuccessfulMoveOnEscapePodSectorEvent(String message) {
        super(message);
