...
public class SuccessfulGivenItemListEvent extends GameEvent {

    /**
     * 
     */
    private static final long serialVersionUID = -733968568248191429L;

    public SuccessfulGivenItemListEvent(String message) {
        super(message);
    }
