...
public class GreenEscapePodEvent extends GameEvent {

    /**
     * 
     */
    private static final long serialVersionUID = -50738628591780380L;

    public GreenEscapePodEvent() {
    }

    public GreenEscapePodEvent(String message) {
        super(message);
    }
